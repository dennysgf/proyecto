...
<head>
  ...
  <title>Listado nocturna | KFC</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3>LISTADO DE ESTUDIANTES EN GENERAL SECCIÓN NOCTURNA</h3>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
        ...
        <div class="row">
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tr >
                    ...
                    <td>
                      <?php
                        echo "<a href='./v_editar_matriculanoc.php?IdMatriculanoc=".$datos['IdMatriculanoc']."'class='btn btn-primary btn-sm'><i class='fa-solid fa-pen-to-square'></i> </a>";
                      ?>
                      <?php
                        echo "<a href='./v_bajanoc.php?IdMatriculanoc=".$datos['IdMatriculanoc']."'class='btn btn-warning btn-sm'><i class='fa-solid fa-user-xmark'></i> </a>";
                      ?>
                      <?php
                        echo "<a href='../estudiante/info_nocturna.php?IdMatriculanoc=".$datos['IdMatriculanoc']."'class='btn btn-info btn-sm'><i class='fa-solid fa-eye'></i> </a>";
                      ?>
                    </td>
                    <?php
                      }
