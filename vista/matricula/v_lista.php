...
<head>
  ...
  <title>Listado matutina | KFC</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3>LISTADO DE ESTUDIANTES EN GENERAL SECCIÓN MATUTINA</h3>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
        ...
        <div class="row">
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <?php
                        ...
                        $sql = $mysqli->query("SELECT * FROM matricula 
                ...
                <tr >
                    ...
                    <td>
                      <?php
                        echo "<a href='./v_editar_matricula.php?IdMatricula=".$datos['IdMatricula']."'class='btn btn-primary btn-sm'><i class='fa-solid fa-pen-to-square'></i> </a>";
                      ?>
                      <?php
                        echo "<a href='./v_baja.php?IdMatricula=".$datos['IdMatricula']."'class='btn btn-warning btn-sm'><i class='fa-solid fa-user-xmark'></i> </a>";
                      ?>
                      <?php
                        echo "<a href='../estudiante/info_matutina.php?IdMatricula=".$datos['IdMatricula']."'class='btn btn-info btn-sm'><i class='fa-solid fa-eye'></i> </a>";
                      ?>
                    </td>
                    <?php
                      }
