    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3>ESTUDIANTES DADOS DE BAJA SECCIÓN: MATUTINA</h3>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
        ...
        <div class="row">
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tr >
                    ...
                    <td>
                      <?php
                        echo "<a href='../../modelo/matricula/eliminar.php?IdMatricula=".$datos['IdMatricula']."'class='btn btn-danger btn-sm'><i class='fa-solid fa-trash'></i> </a>";
                      ?>
                    </td>
                    <?php
                      }
