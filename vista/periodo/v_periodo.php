...
<head>
  ...
  <title>periodo lectivo | KFC</title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3>Ingrese el periodo lectivo</h3>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
    ...
    <div class="container-fluid">
      ...
      <div class="container">
      <form action="../../modelo/periodo/insertar.php" method="post">
        <div class="row">
          <div class="col-9">
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Ingrese el periodo lectivo</label>
                      <input required name="periodo" type="text" class="form-control form-control-border">
                    </div>
                  </div>
                </div>            
              </div>
            ...
            <script>
              $(document).ready(function () {
                ...
                <tr >
                    ...
                    <td>
                      <?php
                        echo "<a href='../../modelo/periodo/eliminar.php?IdPeriodo=".$datos['IdPeriodo']."'class='btn btn-danger btn-sm'><i class='fa-solid fa-trash'></i> eliminar</a>";
                      ?>
                    </td>
                    <?php
                      }
