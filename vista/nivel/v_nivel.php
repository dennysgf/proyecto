...
<div class="wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="container">
      <form action="../../modelo/niveles/insertar.php" method="post">
        <div class="row">
          <div class="col-9">
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-3">
                    ...
                    <label for="">Ingrese el curso a añadir</label>
                      <input required name="nivel" type="text" class="form-control form-control-border">
                    </div>
                  </div>
                </div>            
              </div>
        ...
        <div class="row">
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tr >
                    ...
                    <td>
                      <?php
                        echo "<a href='../../modelo/niveles/eliminar.php?Idnivel=".$datos['Idnivel']."'class='btn btn-danger btn-sm'><i class='fa-solid fa-trash'></i> eliminar</a>";
                      ?>
                    </td>
                    <?php
                      }
