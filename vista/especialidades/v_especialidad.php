...
<head>
  ...
  <title>especialidades | KFC</title>
...
<div class="wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="container">
      <form action="../../modelo/especialidades/insertar.php" method="post">
        <div class="row">
          <div class="col-9">
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-3">
                    ...
                    <label for="">Ingrese la especialidad</label>
                    <input required name="especialidad" type="text" class="form-control form-control-border">
                    </div>
                  </div>
                </div>            
              </div>
        ...
        <div class="row">
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tr >
                    ...
                    <td>
                      <?php
                        echo "<a href='../../modelo/niveles/eliminar.php?IdEspecialidad=".$datos['IdEspecialidad']."'class='btn btn-danger btn-sm'><i class='fa-solid fa-trash'></i> eliminar</a>";
                      ?>
                    </td>
                    <?php
                      }
