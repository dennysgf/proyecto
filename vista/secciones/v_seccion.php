...
<div class="wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="container">
      <form action="../../modelo/seccion/ingresar.php" method="post">
        <div class="row">
          <div class="col-9">
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Ingrese la sección a añadir</label>
                      <input required name="seccion" type="text" class="form-control form-control-border">
                    </div>
                  </div>
                </div>            
              </div>
        ...
        <div class="row">
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                      <?php
                        echo "<a href='../../modelo/seccion/eliminar.php?IdSeccion=".$datos['IdSeccion']."'class='btn btn-danger btn-sm'><i class='fa-solid fa-trash'></i> eliminar</a>";
                      ?>
                    </td>
                    <?php
                      }
