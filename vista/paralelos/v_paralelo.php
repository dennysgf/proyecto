...
<div class="wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="container">
      <form action="../../modelo/paralelo/ingresar.php" method="post">
        <div class="row">
          <div class="col-9">
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                      <label for="">Ingrese el paralelo que desea añadir</label>
                      <input required name="paralelo"  type="text" class="form-control form-control-border">
                    </div>
                  </div>
                </div>            
              </div>
        ...
        <div class="row">
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                      <?php
                        echo "<a href='../../modelo/paralelo/eliminar.php?IdParalelo=".$datos['IdParalelo']."'class='btn btn-danger btn-sm'><i class='fa-solid fa-trash'></i> eliminar</a>";
                      ?>
                    </td>
                    <?php
                      }
