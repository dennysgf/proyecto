          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody id="myTable">
                  <?php 
                    ...
                    $sql=$mysqli->query("SELECT * FROM nocturna");
                  while($resultado = $sql->fetch_assoc()){
                  ?>
                <tr>
                    <td><?php echo $resultado['cedula'];?></td>
                    <td><?php echo $resultado['nombres_noc'];?></td>                                    
                    <td><?php echo $resultado['correo'];?></td>                    
                    <td><?php echo $resultado['celular'];?></td>                                    
                    <td><?php echo $resultado['oferta'];?></td>
                    
                    <?php
                    echo "<td>
                        <a href='v_actualizar_estnoc.php?IdNocturna=".$resultado["IdNocturna"]."' class='btn btn-primary btn-sm'><i class='fa-solid fa-pen-to-square'></i> Editar</a>
