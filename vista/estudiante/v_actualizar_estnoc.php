  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
     ...
     <?php
          ...
          $sql = "SELECT * FROM nocturna WHERE IdNocturna =".$_GET['IdNocturna'];
            ...
            <div class="card card-default">
              ...
              <div class="card-body">
                ...
                <div class="col-md-3">
                    ...
                    <option selected value="<?php echo $row['requisitos']; ?>"><?php echo $row['requisitos']; ?></option>
              ...
              <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <option selected value="<?php echo $row['documento']; ?>"><?php echo $row['documento']; ?></option>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input required maxlength="13"name="cedula" type="text" class="form-control form-control-border"
                        placeholder="" value ="<?php echo $row['cedula']; ?>">
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input required name="nombres" type="text" class="form-control form-control-border"value ="<?php echo $row['nombres_noc']; ?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">fecha de nacimiento</label>
                      <input required name="fecha" type="date" class="form-control form-control-border"value ="<?php echo $row['fecha']; ?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-border" name="lugar" value ="<?php echo $row['lugar']; ?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <option selected value="<?php echo $row['actividad']; ?>"><?php echo $row['actividad']; ?></option>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <option selected value="<?php echo $row['laboral']; ?>"><?php echo $row['laboral']; ?></option>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <option selected value="<?php echo $row['nacionalidad']; ?>"><?php echo $row['nacionalidad']; ?></option>                        
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <option selected value="<?php echo $row['definicion']; ?>"><?php echo $row['definicion']; ?></option>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input  value="<?php echo $row['familia']; ?>" type="text" maxlength="2" class="form-control" name="familia" placeholder="escriba no o sí">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <option selected value="<?php echo $row['hijos']; ?>"><?php echo $row['hijos']; ?></option>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input value="<?php echo $row['discapacidad']; ?>"type="text" maxlength="2" class="form-control form-control-border" name="discapacidad" placeholder="escriba si o no">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">tipo de discapacidad</label>
                      <input value="<?php echo $row['tipodisca']; ?>"type="text" class="form-control form-control-border" name="tipodisca">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">porcentaje de discapacidad</label>
                      <input value="<?php echo $row['porcentaje']; ?>"type="text" class="form-control form-control-border" name="porcentaje">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">¿Recibe bono de desarrollo humano?</label>
                      <input value="<?php echo $row['bono']; ?>"type="text"maxlength="2" class="form-control form-control-border" name="bono"  placeholder="escriba no o si ">
                    </div>
                  </div>    
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Teléfono celular</label>
                      <input value="<?php echo $row['celular']; ?>"maxlength="10" type="text" class="form-control form-control-border" name="celular">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Teléfono convencional</label>
                      <input value="<?php echo $row['convencional']; ?>" type="text" class="form-control form-control-border" name="convencional">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Correo electrónico</label>
                      <input value="<?php echo $row['correo']; ?>"type="email" class="form-control form-control-border" name="correo">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Código único electrico</label>
                      <input value="<?php echo $row['codigo']; ?>"type="text" class="form-control form-control-border" name="codigo">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <option selected value="<?php echo $row['rezago']; ?>"><?php echo $row['rezago']; ?></option>
                        <option value="3 - 5 años dentro del sistema educativo" style="justify-content: center;">3 - 5 años dentro del sistema educativo</option>
                        <option value="3 - 5 años fuera del sistema educativo" style="justify-content: center;">3 - 5 años fuera del sistema educativo</option> 
                        <option value="Menos de 3 años de rezago,14 años, 16 años y 17" style="justify-content: center;">Menos de 3 años de rezago,14 años, 16 años y 17</option>
                        <option value="Más de 10 años fuera del sistema" style="justify-content: center;">Más de 10 años fuera del sistema</option>
                        <option value="6 - 10 años fuera del sistema educativo" style="justify-content: center;">6 - 10 años fuera del sistema educativo</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input value="<?php echo $row['zona']; ?>"type="text" class="form-control form-control-border" name="zona">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-md-3">
                          <div class="form-group">
                              ...
                              <input value="<?php echo $row['canton']; ?>"name="canton" type="text" class="form-control form-control-border">
                           </div>
                        </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Parroquia</label>
                      <input value="<?php echo $row['parroquia']; ?>"type="text" class="form-control form-control-border" name="parroquia">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Sector</label>
                      <input value="<?php echo $row['sector']; ?>"type="text" class="form-control form-control-border" name="sector" placeholder="Escriba: uraba o rural">
                    </div>
                  </div>
                  <div class="col-md-9">
                    <div class="form-group">
                      <label for="">dirección (barrio/comunidad/sector/calle principal/calle secundaria/referencia)</label>
                      <input value="<?php echo $row['direccion']; ?>"type="text" class="form-control form-control-border" name="direccion" placeholder="Escriba: uraba o rural">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Último año aprobado</label>
                              ...
                              <option selected value="<?php echo $row['aprobado']; ?>"><?php echo $row['aprobado']; ?></option>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Oferta educativa en la que desea inscribirse</label>
                              ...
                              <option selected value="<?php echo $row['oferta']; ?>"><?php echo $row['oferta']; ?></option>
