    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Listado de estudiantes en general</h1>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody id="myTable">
                  <?php 
                    ...
                    INNER JOIN documento on estudiante.id_tipo = documento.IdDocumento 
                    INNER JOIN provincia on estudiante.id_provincia = provincia.IdProvincia  
                    INNER JOIN canton on estudiante.id_canton= canton.IdCanton
                    INNER JOIN representante on estudiante.id_representante= representante.IdRepresentante
                    INNER JOIN telefono on estudiante.id_telefono=telefono.IdTelefono");
                  while($resultado = $sql->fetch_assoc()){
                  ?>
                <tr>
                    <td><?php echo $resultado['identificacion_e'];?></td>
                    <td><?php echo $resultado['apellido'];?></td>
                    <td><?php echo $resultado['nombre'];?></td>                                     
                    <td><?php echo $resultado['email_e'];?></td>                    
                    <td><?php echo $resultado['n_telefono_e'];?></td>                                    
                    <td><?php echo $resultado['nombres']." ".$resultado['apellidos'];?></td>
                    
                    <?php
                    echo "<td>
                        <a href='vt_actualizar_est.php?IdEsudiante=".$resultado["IdEsudiante"]."' class='btn btn-primary btn-sm'><i class='fa-solid fa-pen-to-square'></i> Editar</a>
