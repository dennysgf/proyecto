...
<head>
  ...
  <title>Actualizar datos | KFC</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Actualizar información del representante</h1>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
      ...
      <!-- Main content -->
      <form action="../../modelo/mod_actualizar_rep.php" method="post">
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      value="<?php echo $row['instruccion']; ?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      value="<?php echo $row['calle_principal']; ?>">
                    </div>
                  </div>
                  <div class="col-md-4">
                      <div class="form-group">
                        ...
                        value="<?php echo $row['calle_secundaria']; ?>">
                      </div>
                    </div>
                  <div class="col-md-4">
                    <div class="form-group">
