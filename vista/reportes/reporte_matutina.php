    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3>REPORTE POR FECHAS - SECCIÓN MATUTINA</h3>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
              <div class="container-fluid">
              <form action="../../modelo/reportes/reporte_matutina.php" method="post">
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-1">
                        <button class="btn btn-success" type="submit"><i class="fa-solid fa-file-csv"></i></button>
                    </div>
                </div><br>
                </form>
            <script>
