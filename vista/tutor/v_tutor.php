...
<div class="wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="container">
      <form action="../../modelo/tutor/insertar.php" method="post">
        <div class="row">
          <div class="col-9">
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                      <label for="">Ingrese el tutor que desea añadir</label>
        ...
        <div class="row">
          ...
          <table id="example2" class="table table-bordered table-hover">
                ...
                <tr >
                    ...
                    <td>
                      <?php
                        echo "<a href='../../modelo/tutor/eliminar.php?IdTutor=".$datos['IdTutor']."'class='btn btn-danger btn-sm'><i class='fa-solid fa-trash'></i> eliminar</a>";
                      ?>
                    </td>
                    <?php
                      }
